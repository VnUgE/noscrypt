...
This is a fork of the original mbedtls library found on [GitHub](https://github.com/Mbed-TLS/mbedtls/). As per the license this is a notice of modifications made to the original source code. The original license can be found intact in the LICENSE file.
